...
const ContactSection = () => {
  return (
    <section id="contact" className="section-padding bg-portfolio-purple/5 relative overflow-hidden">
      {/* Background elements */}
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:contact@rightsiman.com" className="font-medium hover:underline">
